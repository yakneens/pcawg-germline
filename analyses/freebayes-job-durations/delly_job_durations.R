...
ggplot(del_task_instances, aes(duration)) + geom_histogram(bins=50) + xlab("Duration (hours)") 
...
ggplot(dup_task_instances, aes(duration)) + geom_histogram(bins=50) + xlab("Duration (hours)") 
