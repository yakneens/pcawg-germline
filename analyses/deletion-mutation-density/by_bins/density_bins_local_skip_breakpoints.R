...
filtered_deletion_ranges = narrow(filtered_deletion_ranges, start=201, end=-201)

pre_deletion_ranges = GenomicRanges::shift(trim(flank(filtered_deletion_ranges, width(filtered_deletion_ranges), start = T)), -400)
post_deletion_ranges = GenomicRanges::shift(trim(flank(filtered_deletion_ranges, width(filtered_deletion_ranges), start = F)), 400)
